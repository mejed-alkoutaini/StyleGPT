...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy | StyleGPT</title>
      </Head>
      ...
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg">
            ...
            <h2 className="mt-6 font-semibold text-xl">Interpretation and Definitions</h2>
            <h3 className="mt-6 font-semibold text-xl">Interpretation</h3>
            <p className="mt-4">
              The words of which the initial letter is capitalized have meanings defined under the following conditions.
              The following definitions shall have the same meaning regardless of whether they appear in singular or in
              plural.
            </p>
            <h3 className="mt-6 font-semibold text-xl">Definitions</h3>
            ...
            <ul>
              ...
              <li>
                <p className="mt-4">
                  <strong>Application</strong> refers to StyleGPT, the software program provided by the Company.
                </p>
              </li>
              <li>
                <p className="mt-4">
                  <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to StyleGPT.
                </p>
              </li>
              <li>
                <p className="mt-4">
            ...
            <h2 className="mt-6 font-semibold text-xl">Collecting and Using Your Personal Data</h2>
            <h3 className="mt-6 font-semibold text-xl">Types of Data Collected</h3>
            <h4 className="mt-6 font-semibold text-xl">Personal Data</h4>
            <p className="mt-4">
            ...
            <ul>
              ...
              <li>
                <p className="mt-4">First name and last name</p>
              </li>
              <li>
                <p className="mt-4">Phone number</p>
              </li>
              <li>
                <p className="mt-4">Usage Data</p>
              </li>
            </ul>
            <h4 className="mt-6 font-semibold text-xl">Usage Data</h4>
            ...
            <h4 className="mt-6 font-semibold text-xl">Information Collected while Using the Application</h4>
            <p className="mt-4">
            ...
            <h3 className="mt-6 font-semibold text-xl">Retention of Your Personal Data</h3>
            <p className="mt-4">
            ...
            <h3 className="mt-6 font-semibold text-xl">Transfer of Your Personal Data</h3>
            <p className="mt-4">
            ...
            <h3 className="mt-6 font-semibold text-xl">Delete Your Personal Data</h3>
            <p className="mt-4">
            ...
            <h3 className="mt-6 font-semibold text-xl">Disclosure of Your Personal Data</h3>
            <h4 className="mt-6 font-semibold text-xl">Business Transactions</h4>
            <p className="mt-4">
            ...
            <h4 className="mt-6 font-semibold text-xl">Law enforcement</h4>
            <p className="mt-4">
            ...
            <h4 className="mt-6 font-semibold text-xl">Other legal requirements</h4>
            <p className="mt-4">
            ...
            <h3 className="mt-6 font-semibold text-xl">Security of Your Personal Data</h3>
            <p className="mt-4">
            ...
            <h2 className="mt-6 font-semibold text-xl">Children's Privacy</h2>
            <p className="mt-4">
            ...
            <h2 className="mt-6 font-semibold text-xl">Links to Other Websites</h2>
            <p className="mt-4">
            ...
            <h2 className="mt-6 font-semibold text-xl">Changes to this Privacy Policy</h2>
            <p className="mt-4">
