      ...
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg">
            <h1 className="mt-4 font-semibold text-4xl">TERMS OF SERVICE</h1>

            <p className="mt-4">OVERVIEW</p>

            <p className="mt-4">
              This website is operated by StyleGPT. Throughout the site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo;
              and &ldquo;our&rdquo; refer to StyleGPT. StyleGPT offers this website, including all information, tools
            ...
            <p className="mt-4">
              ...
              limitation users who are browsers, vendors, customers, merchants, and/ or contributors of content. Please
              read these Terms of Service carefully before accessing or using our website. By accessing or using any
            ...
            <p className="mt-4">
              ...
              those changes. Our store is hosted on Shopify Inc. They provide us with the online e-commerce platform
              that allows us to sell our products and Services to you.
            </p>

            <h2 className="mt-8 font-semibold text-xl">SECTION 1 - ONLINE STORE TERMS</h2>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 2 - GENERAL CONDITIONS</h2>

            <p className="mt-4">We reserve the right to refuse service to anyone for any reason at any time.</p>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>

            <p className="mt-4">Prices for our products are subject to change without notice.</p>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h2>
            ...
            <p className="mt-4">
              ...
              Policy. To view our Return Policy, please visit <a href="/refund-policy">Return Policy</a>
            </p>
            ...
            <p className="mt-4">
              ...
              products or product pricing are subject to change at anytime without notice, at the sole discretion of us.
              We reserve the right to discontinue any product at any time. Any offer for any product or service made on
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
            ...
            <p className="mt-4">
              ...
              was made. We reserve the right to limit or prohibit orders that, in our sole judgment, appear to be placed
              by dealers, resellers or distributors. You agree to provide current, complete and accurate purchase and
              account information for all purchases made at our store. You agree to promptly update your account and
              other information, including your email address and credit card numbers and expiration dates, so that we
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 7 - OPTIONAL TOOLS</h2>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 8 - THIRD-PARTY LINKS</h2>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
            ...
            <p className="mt-4">
              ...
              confidence; (2) to pay compensation for any comments; or (3) to respond to any comments. We may, but have
              no obligation to, monitor, edit or remove content that we determine in our sole discretion to be unlawful,
              offensive, threatening, libelous, defamatory, pornographic, obscene or otherwise objectionable or violates
              any party&rsquo;s intellectual property or these Terms of Service. You agree that your comments will not
              violate any right of any third-party, including copyright, trademark, privacy, personality or other
              personal or proprietary right. You further agree that your comments will not contain libelous or otherwise
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 10 - PERSONAL INFORMATION</h2>

            <p className="mt-4">
              Your submission of personal information through the store is governed by our Privacy Policy. To view our
              Privacy Policy, please see <a href="/privacy-policy">Privacy Policy</a>
            </p>

            <h2 className="mt-8 font-semibold text-xl">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 12 - PROHIBITED USES</h2>
            ...
            <p className="mt-4">
              ...
              durability, title, and non-infringement. In no case shall StyleGPT, our directors, officers, employees,
              affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any
              ...
              service, or for any other claim related in any way to your use of the service or any product, including,
              but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as
              a result of the use of the service or any content (or product) posted, transmitted, or otherwise made
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 14 - INDEMNIFICATION</h2>

            <p className="mt-4">
              You agree to indemnify, defend and hold harmless StyleGPT and our parent, subsidiaries, affiliates,
              partners, officers, directors, agents, contractors, licensors, service providers, subcontractors,
              suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys&rsquo;
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 15 - SEVERABILITY</h2>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 16 - TERMINATION</h2>
            ...
            <p className="mt-4">
              ...
              you cease using our site. If in our sole judgment you fail, or we suspect that you have failed, to comply
              with any term or provision of these Terms of Service, we also may terminate this agreement at any time
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 17 - ENTIRE AGREEMENT</h2>
            ...
            <p className="mt-4">
              ...
              Service). Any ambiguities in the interpretation of these Terms of Service shall not be construed against
              the drafting party.
            </p>

            <h2 className="mt-8 font-semibold text-xl">SECTION 18 - GOVERNING LAW</h2>

            <p className="mt-4">
              These Terms of Service and any separate agreements whereby we provide you Services shall be governed by
              and construed in accordance with the laws of T&uuml;rkiye.
            </p>

            <h2 className="mt-8 font-semibold text-xl">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
            ...
            <h2 className="mt-8 font-semibold text-xl">SECTION 20 - CONTACT INFORMATION</h2>

            <p className="mt-4">Questions about the Terms of Service should be sent to us at Contact@StyleGPT.io .</p>
          </div>
        </div>
      </div>
