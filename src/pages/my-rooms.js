...
export default function MyRooms() {
  ...
  // Fetches the user's images from the API and updates the state
  const getData = async () => {
    setIsLoading(true);

    const images = await getUserImages(userData.uid);
  ...
  // Filters the images based on selected type and theme filters
  useEffect(() => {
    const filterImages = () => {
